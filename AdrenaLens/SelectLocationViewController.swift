...
class SelectLocationViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let longPress = UILongPressGestureRecognizer(target: self, action: #selector(SelectLocationViewController.actionAddPinAtPoint(_:)))
            ...
            .responseJSON { response in
                ...
                case .Success(let data):
                    ...
                    if let Status = json["status"].string,
                        PlaceList = json["predictions"].arrayObject
                        where Status == "OK"
                    {
                        print(PlaceList)
