...
public class PDImageScrollView: UIScrollView, UIScrollViewDelegate {
    ...
    public func displayImage(image: UIImage) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(PDImageScrollView.doubleTapGestureRecognizer(_:)))
    ...
    @objc private func doubleTapGestureRecognizer(gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= maximumZoomScale / 2.0 {
            ...
            let zoomRect = zoomRectForScale(PDImageScrollView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale, center: center)
